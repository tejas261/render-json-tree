...
var JsonTree = function (_a) {
    ...
    var _c = reactExports.useState(false), isTooltipVisible = _c[0], setIsTooltipVisible = _c[1];
    var _d = reactExports.useState(data), jsonData = _d[0], setJsonData = _d[1];
    var _e = reactExports.useState(null), editingKey = _e[0], setEditingKey = _e[1];
    var _f = reactExports.useState(""), editingValue = _f[0], setEditingValue = _f[1];
    var _g = reactExports.useState({}), expandedKeys = _g[0], setExpandedKeys = _g[1];
    var _h = reactExports.useState(null), hoveredKey = _h[0], setHoveredKey = _h[1];
    var _j = reactExports.useState(""), newKey = _j[0], setNewKey = _j[1];
    var _k = reactExports.useState(""), newValue = _k[0], setNewValue = _k[1];
    var _l = reactExports.useState(false), editingField = _l[0], setEditingField = _l[1];
            ...
            return (jsxRuntimeExports.jsx("div", { style: {
                    ...
                    backgroundColor: appliedBackgroundColor,
                            ...
                            marginTop: "4px",
                                    ...
                                    backgroundColor: "transparent",
                                }, onBlur: function () { return handleBlur(fullKey); }, autoFocus: true })) : (jsxRuntimeExports.jsx("span", { style: {
                                    overflow: "hidden",
