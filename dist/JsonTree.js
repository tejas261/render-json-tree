...
var JsonTree = function (_a) {
    var data = _a.data, width = _a.width, _b = _a.viewStyle, viewStyle = _b === void 0 ? "light" : _b, backgroundColor = _a.backgroundColor, keyTextColor = _a.keyTextColor, valueTextColor = _a.valueTextColor, fontSize = _a.fontSize, fontStyle = _a.fontStyle;
    // Apply color scheme based on viewStyle, falling back to specific props if provided
    var selectedColors = colorPalette_1.colorSchemes[viewStyle];
    ...
    var _c = (0, react_1.useState)(data), jsonData = _c[0], setJsonData = _c[1];
    var _d = (0, react_1.useState)(null), editingKey = _d[0], setEditingKey = _d[1];
    var _e = (0, react_1.useState)(""), editingValue = _e[0], setEditingValue = _e[1];
    var _f = (0, react_1.useState)({}), expandedKeys = _f[0], setExpandedKeys = _f[1];
    var _g = (0, react_1.useState)(null), hoveredKey = _g[0], setHoveredKey = _g[1];
    var _h = (0, react_1.useState)(""), newKey = _h[0], setNewKey = _h[1];
    var _j = (0, react_1.useState)(""), newValue = _j[0], setNewValue = _j[1];
    var _k = (0, react_1.useState)(false), editingField = _k[0], setEditingField = _k[1];
            ...
            return ((0, jsx_runtime_1.jsx)("div", { style: {
                    ...
                    backgroundColor: appliedBackgroundColor,
                                    ...
                                    alignItems: "center",
                                            ...
                                            cursor: "pointer",
                                            marginLeft: "4px",
                                        }, color: "".concat(viewStyle == "dark" ? "#fff" : "#000"), size: 16, onClick: function () {
                            ...
                            paddingLeft: "1.25rem",
                            marginTop: "4px",
                        }, onClick: function () { return handleEdit(fullKey, String(data[key])); }, children: [(0, jsx_runtime_1.jsxs)("span", { style: { color: appliedKeyTextColor }, children: [key, ": "] }), editingKey === fullKey ? ((0, jsx_runtime_1.jsx)("input", { type: "text", value: editingValue, onChange: handleChange, style: {
                                    border: "none",
                                    outline: "none",
                                    overflow: "scroll",
    ...
    return ((0, jsx_runtime_1.jsxs)("div", { className: "".concat(fontStyle || "fira-code"), style: {
            ...
            overflow: 'auto',
                    ...
                    marginBottom: "4px",
                }, children: (0, jsx_runtime_1.jsx)(lucide_react_1.Copy, { color: "".concat(viewStyle == "dark" ? "#fff" : "#000"), size: 20, style: {
                        cursor: "pointer",
                        border: "1px",
                        borderRadius: "2px",
                    }, onClick: copyToClipboard }) }), renderTree(jsonData)] }));
};
